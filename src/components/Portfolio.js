  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-4 right-4 bg-green-500 text-white px-4 py-2 rounded-full flex items-center shadow-lg hover:bg-green-600 transition-colores duration-300"
        >
